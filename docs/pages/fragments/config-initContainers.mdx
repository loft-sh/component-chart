initContainers:               # struct[]  | Array of containers
- name: some-container        # string    | Container name (optional)
  ...
  livenessProbe: ...          # struct    | Not allowed in init containers
  readinessProbe: ...         # struct    | Not allowed in init containers
  startupProbe: ...           # struct    | Not allowed in init containers
